...
cd /hb/scratch/jharenca/vill_alle_plate1/newdata/whole_plate_mapping/trimmomatic_cleaned
...
# Trailing: same think on end of read. 
# Minlen: drop read if it is below a specific length (I did not do this) 
